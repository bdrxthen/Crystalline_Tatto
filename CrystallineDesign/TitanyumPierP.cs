...
{
    public partial class TitanyumPierP : Form
    {
        public TitanyumPierP()
        {
            InitializeComponent();
        }
        ...
        private void TitanyumPierP_Load(object sender, EventArgs e)
        {
        ...
        private void Ekle_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    var nickkarsi = client1.Get("TitanyumPier/" + Id.Text);
                ...
                catch
                {
                    if (Id.Text != Karsilastir.Text)
                    {
                        ...
                        var setter = client1.Set("TitanyumPier/" + Id.Text, Rsm1);
                    }
                    else
                    {
        ...
        private async void Listele_Click(object sender, EventArgs e)
        {
            ...
            while (true)
            {
                try
                {
                    var Res = await client1.GetAsync("TitanyumPier/" + i);
