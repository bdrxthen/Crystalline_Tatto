...
{
    public partial class GumusPiercP : Form
    {
        public GumusPiercP()
        {
            InitializeComponent();
        ...
        private void GumusPiercP_Load(object sender, EventArgs e)
        {
        ...
        private void Ekle_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    var nickkarsi = client1.Get("GumusPier/" + Id.Text);
                ...
                catch
                {
                    if (Id.Text != Karsilastir.Text)
                    {
                        ...
                        var setter = client1.Set("GumusPier/" + Id.Text, Rsm1);
                    }
                    else
                    {
        ...
        private async void Listele_Click(object sender, EventArgs e)
        {
            ...
            while (true)
            {
                try
                {
                    var Res = await client1.GetAsync("GumusPier/" + i);
