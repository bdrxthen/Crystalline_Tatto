...
{
    public partial class RenkliDovmeP : Form
    {
        public RenkliDovmeP()
        {
            InitializeComponent();
        ...
        private void RenkliDovmeP_Load(object sender, EventArgs e)
        {
        ...
        private void Ekle_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    var nickkarsi = client1.Get("RenkliDovme/" + Id.Text);
                ...
                catch
                {
                    if (Id.Text != Karsilastir.Text)
                    {
                        ...
                        var setter = client1.Set("RenkliDovme/" + Id.Text, Rsm1);
                    }
                    else
                    {
        ...
        private async void Listele_Click(object sender, EventArgs e)
        {
            ...
            while (true)
            {
                try
                {
                    var Res = await client1.GetAsync("RenkliDovme/" + i);
